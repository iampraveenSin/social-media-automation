...
function rowToAccount(r: Record<string, unknown>): InstagramAccount {
  return {
    ...
    facebookPageName: r.facebook_page_name as string | undefined,
    username: r.username as string,
    profilePictureUrl: r.profile_picture_url as string | undefined,
    mediaCount: r.media_count != null ? Number(r.media_count) : undefined,
...
export async function saveAccount(account: InstagramAccount): Promise<void> {
  ...
  const row = {
    ...
    facebook_page_name: account.facebookPageName ?? null,
