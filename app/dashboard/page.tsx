...
export default function DashboardPage() {
  ...
  const [account, setAccount] = useState<{ connected: boolean; username?: string; profilePictureUrl?: string | null; facebookPageName?: string | null; mediaCount?: number | null; suggestedNiche?: string | null }>({ connected: false });
